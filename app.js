...
import { EnemyOne } from './enemies.js';
...
let imCoorX = canvasWidth - birdWidth + 150;
  ...
  function addNewBird () {
    ...
    enemies.push(new EnemyOne(enemyForStageOne, birdWidth, birdHeight, enemyForStageOneWidth, enemyForStageOneHeight, imCoorX, imCoorY));
    console.log(enemies, enemyForStageOne, birdWidth, birdHeight, enemyForStageOneWidth, enemyForStageOneHeight, imCoorX, imCoorY);
